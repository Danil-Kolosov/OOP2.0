...
namespace Project1
{
    internal class MyCollection<T> : /*MyEnumerator<T>,*/ /*!!!IEnumerable<T>,*/ ICollection<T>
    {
        //T begin;
        Point<T> begin;
        ...
        {
            if (hashTable == null)
                Console.WriteLine("В хэш таблицу еще не был добавлен ни один элемент");
            else 
            {
        ...
        public int Count { get { return hashTable.Length; } }
        ...
        public MyCollection<T> DeepCloning()
        {
            ...
            return new MyCollection<T>(newTable);
        }

        public MyCollection<T> Copyng(/*Point<T>[] oldTable*/) 
        {

            return new MyCollection<T>(hashTable);
