...
namespace Project1
{
    internal class Programm
    {
        public static void Main() 
        {
            ...
            MyCollection<Animal> constructZoo = new MyCollection<Animal>(zoo);
            constructZoo.Print();
            ...
            MyCollection<Animal> deepClonZoo = zoo.DeepCloning();
            deepClonZoo.Print();
            ...
            MyCollection<Animal> copyingZoo = zoo.Copyng();
            copyingZoo.Print();
            ...
            Console.WriteLine("\nИмея коллекцию:");
            constructZoo.Print();
            Console.WriteLine("С помощью цикла foreach выведем ее элементы:");
            foreach (Animal a in constructZoo) 
            { 
                Console.WriteLine(a); 
            }     
        }
